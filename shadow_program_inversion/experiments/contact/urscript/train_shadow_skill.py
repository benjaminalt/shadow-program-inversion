...
def main(args):
    ...
    shadow_skill = ShadowSkill("Move Linear", static_input_size=9, model_config=model_config, simulator=sim)
    data_dir = os.path.join(cfg.DATA_DIR, "urscript", args.material, "train")
